...
router.patch('/updatePassword',authCpntroller.protect ,authCpntroller.updatePassword)
...
router.route('/:id').delete(userController.deleteUser).patch(userController.updateUser).get(userController.getOne)
